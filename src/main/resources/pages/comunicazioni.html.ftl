<html>
<body>
<p>Gentile <b>${user.getFirstName()?cap_first} ${user.getLastName()?cap_first}</b>,</p>
<p>sono presenti nuove comunicazioni nella Sua area personale del Portale della performance.</p>
<br>
<p>Cordiali saluti</p>
<br>
<img src="cid:logo-mail.png"></img>
