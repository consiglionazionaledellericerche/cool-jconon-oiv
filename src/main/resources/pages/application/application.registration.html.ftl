...
<#assign subject = "ELENCO_NAZIONALE_" + folder.getPropertyValue("jconon_application:cognome")?upper_case + "_" + folder.getPropertyValue("jconon_application:nome")?upper_case>
...
<p>${message('mail.confirm.application.oiv', subject, subject)} </p>
