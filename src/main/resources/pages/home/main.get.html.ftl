...
Al termine dell’inserimento dei dati verrà inviata una email di conferma all’indirizzo di posta elettronica fornito in fase di registrazione con allegata la  domanda di iscrizione. Nella domanda, scaricabile anche dalla pagina personale del profilo creato in fase di registrazione, sarà indicata la fascia professionale attribuita sulla base delle informazioni inserite. Una volta scaricato il file, la domanda dovrà essere sottoscritta con firma digitale (mediante l'uso di Smart Card e software già in vostro possesso) o, qualora non si possegga la firma digitale, stampata e firmata, e inviata all'indirizzo di Posta Elettronica Certificata: <a href="mailto:protocollo_dfp@mailbox.governo.it">protocollo_dfp@mailbox.governo.it</a>; l'oggetto del messaggio dovrà contenere esclusivamente le parole ELENCO_NAZIONALE_NOME_COGNOME. 
L’iscrizione diverrà efficace a decorrere dalla comunicazione da parte del Dipartimento della funzione pubblica della completezza delle informazioni fornite, della sussistenza dei requisiti di competenza, esperienza e integrità di cui all’articolo 2 e dell’avvenuta collocazione in una delle fasce professionali di cui all’articolo 5.      
      </p>
